...
import img4 from "@/assets/page/img4.jpg";
import img3 from "@/assets/card2.jpg";
import img14 from "@/assets/page/img14.jpg";
import img13 from "@/assets/page/img13.jpeg";
    ...
    <main className="overflow-x-hidden">
      ...
      <section className=" w-full justify-center items-center flex  py-6  bg-bg">
        <div className="w-[70%] justify-center items-center flex flex-col ">
          <h1 className="text-3xl my-7 max-md:text-2xl font-semibold">
          ...
          <div className="flex flex-row-reverse w-full mt-[3%] mb-[10%] h-auto justify-center items-center max-lg:flex-col ">
            <p className=" flex flex-1 my-3 mb-6 leading-loose ml-7 max-lg:mt-[5%]">
              ...
              in a factory-controlled environment before being transported to
              the construction site for assembly. This method involves the
              precise fabrication of modules or sections, which are then
              seamlessly integrated to form a complete structure. Unlike
              traditional construction methods, modular construction offers
              greater efficiency, quality control, and sustainability,
              revolutionizing the way buildings are designed and built.
            </p>
          ...
          <div className="w-full h-auto justify-center items-center flex flex-col">
            <h3 className="text-3xl my-3  max-lg:text-2xl">
              Modular vs Traditional
            </h3>
            <p className="my-[3%] font-semibold">
              Modular construction revolutionizes the traditional building
              process by prefabricating components off- site, offering numerous
              advantages over conventional construction methods. This comparison
              outlines the distinct characteristics of modular and traditional
              construction approaches, shedding light on their respective
