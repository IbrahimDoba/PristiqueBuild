        ...
        <div className="grid md:grid-cols-5 gap-8">
          <div className="md:col-span-3">
            ...
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
              At Aso Grove, we showcased how Light Gauge Steel roofing can revolutionize 
              renovations — reducing maintenance, improving safety, and increasing property value.
            </p>
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              This project embodies our philosophy:{" "}
              <strong>Build smarter. Build stronger. Build for the future.</strong>
            </p>
